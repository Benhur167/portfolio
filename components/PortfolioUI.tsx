        ...
        >
          ...
          <div className="flex flex-col md:flex-row gap-12 pointer-events-auto">
            ...
            <div className="flex-1 flex flex-col gap-6">
              ...
              <a
                href="/Ben_Resume (2).pdf"
                download="Ben_Resume (2)"
      ...
      <section id="contact" className="w-full min-h-[70vh] flex flex-col items-center justify-center px-8 py-24 text-center">
        ...
        >
          ...
          <div className="flex gap-6 justify-center">
            ...
            <a href="https://www.linkedin.com/in/benhur167" target="_blank" rel="noreferrer" className="w-14 h-14 rounded-full border border-white/20 bg-white/5 backdrop-blur-md flex items-center justify-center hover:bg-white hover:text-black transition-all duration-300">
